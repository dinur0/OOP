...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        listStud.add(s5);
        listStud.add(s6);
        AverageAge<Student> studListOfAges = new AverageAge<Student>(listStud);
        System.out.println(studListOfAges);
        ...
        Student s10 = new Student("Сергей", "Иванов", 22, (long)101);
        Teacher teacher1 = new Teacher("Мария", "Стрелкова", 54, 410, "академик");

        //EmploeeController contrEmp = new EmploeeController();
        EmploeeController.paySalary(peron1);
        TeacherController.paySalary(teacher1);
